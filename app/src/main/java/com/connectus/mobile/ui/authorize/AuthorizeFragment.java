...
public class AuthorizeFragment extends Fragment {
    private static final String TAG = AuthorizeFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        authorizeViewModel = new ViewModelProvider(this).get(AuthorizeViewModel.class);
        ...
        buttonProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isPhoneNumberValid) {
                    ...
                    authorizeViewModel.hitAuthorizeApi(getActivity(), phoneNumber).observe(getViewLifecycleOwner(), new Observer<ResponseDTO>() {
                        @Override
