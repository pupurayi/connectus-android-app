package com.connectus.mobile.ui.withdraw;
...
import com.connectus.mobile.ui.transfer.TransferFragment;
...
public class CashWithdrawalFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        loadAvatar(profileDTO.isAvatarAvailable(), profileDTO.getUserId(), imageViewProfileAvatar);
